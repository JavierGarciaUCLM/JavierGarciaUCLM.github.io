import"./hoisted.DI_CKeFi.js";async function o(){const t=await fetch("https://dev.azure.com/SE2425TheAvengers/_apis/projects/SEIIProject?api-version=7.0",{method:"GET",headers:{Authorization:`Basic ${btoa(":"+"6yXt6ztCVl5lMT5W7sLQxnD5uEjWplFgQA1HhkSLfi85sXrYJ6XGJQQJ99BAACAAAAAJsFPkAAASAZDOWTYs")}`}});if(!t.ok){document.getElementById("devops-project").innerHTML="<p>Error fetching project data. Please check the token or project URL.</p>";return}const e=await t.json();document.getElementById("devops-project").innerHTML=`
