import"./hoisted.DI_CKeFi.js";async function e(){const t=await(await fetch("https://api.github.com/repos/JavierGarciaUCLM/Jobder")).json();document.getElementById("github-repo").innerHTML=`
