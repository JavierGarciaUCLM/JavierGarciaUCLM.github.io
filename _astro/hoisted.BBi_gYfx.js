import"./hoisted.BScVxmeO.js";async function e(){const t=await(await fetch("https://api.github.com/repos/JavierGarciaUCLM/MinecraftBot")).json();document.getElementById("github-repo").innerHTML=`
